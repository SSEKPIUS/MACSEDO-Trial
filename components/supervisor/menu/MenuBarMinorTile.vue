<template>
  <div>
    <div class=" flex flex-row justify-center items-center border bg-gray-500 rounded-md">
      <div class=" text-center mr-5 ml-5" style=" flex-basis: 50%;">
        <span class=" uppercase font-bold text-center text-white">{{ menu.stocks }}</span>
      </div>
      <div class=" flex flex-row bg-gray-300 w-full px-5 py-2 justify-end">
