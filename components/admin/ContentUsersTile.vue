<template>
  <div class="w-auto p-3">
    <div class="flex flex-col rounded overflow-hidden h-auto border shadow-2xl p-3">
      <div class="flex justify-center items-center w-full">
        <img
          ...
          @click="toggleTooltip()"
        >
        <div class="flex flex-row w-full justify-end items-end align-top">
          <button
            v-if="!loadingDel"
      ...
      >
        <div class="m-0 p-0">
          <div
            class="bg-gray-400  text-white  opacity-75 font-semibold  p-3  mb-0  border-b border-solid border-blueGray-100  uppercase  rounded-t-lg flex flex-row"
          >
            <svg
            ...
            <span class="pl-4 text-gray-900">update profile picture ({{ uploadPercentage }}%)</span>
          </div>
          <label class="p-1 text-xs" for="file">
            <input
              id="file"
              ref="fileInput"
              class="m-1 rounded-sm"
              name="file"
              type="file"
      ...
      <!---->
      <div class="flex justify-center items-center w-full">
        <div class="text-black font-bold text-xl mb-2 leading-tight w-full">
          {{ user.name }}
        </div>
      </div>

      <div class="flex justify-center items-center w-full">
        <div class="flex flex-row w-full justify-start items-end mt-2">
            ...
            >
              ...
              >
                <div class="flex flex-row">
                  <button
                    v-if="!loadingVerify"
                    class=" w-full  bg-transparent  hover:bg-blue-500  text-red-700  font-semibold  hover:text-white py-0 px-4 border border-blue-500  hover:border-transparent rounded"
