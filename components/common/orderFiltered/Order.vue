<template>
  ...
  <div class="container mx-auto bg-gray-50 p-2 antialiased">
    <div>
      <!-- start  -->
      <div class="bg-gray-100 mx-auto border-gray-500 rounded-lg shadow-lg text-gray-700 h-auto">
        <div class="flex p-3 border-l-8" :class="getorderStatus(parseInt(order.status)).styeBorder">
          ...
          <div class="flex-1">
            <div class="ml-3 space-y-1 pr-3">
              ...
              <div class="text-xl leading-4 font-normal text-blue-600 font-black">
                <span class="text-xs leading-4 font-normal text-black"> `Quantity:`</span>  {{ order.qty }} {{ 'Unit' | pluralize( parseInt(order.qty)) }}
              </div>
              <div class="text-sm leading-4 font-normal">
