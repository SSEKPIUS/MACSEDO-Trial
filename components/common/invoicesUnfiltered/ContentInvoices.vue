...
<template>
  <div>
    <div class=" w-full p-2 h-full">
      <div class=" w-full p-2 border  shadow-2xl rounded">
        <div class="p-1 rounded-l-md h-8 w-min rounded" :class="getloadingInvoice ? '' : 'bg-gray-200'">
          <svg
      ...
      <!--pagination-->
      <div v-show="getInvoicePaginated.links" class=" w-full p-2 border  shadow-2xl rounded mt-2  ">
